...
\input{content/Theroy}
\input{content/dataset}
\input{content/topic_ranking}
\input{content/Automatic_Topic_Labeling}
\input{content/intern_consistency}
\input{content/future_work_and_conclusion}
...
\input{content/App_Internal_Consistency}
\input{content/App_ATL}      % INCLUDE: appendix
%
{%
\setstretch{1.1}
