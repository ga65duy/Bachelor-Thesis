...
\includegraphics[width=7cm]{gfx/Eval_IC/English forums_Entropy.pdf}
...
\begin{minipage}[t]{0.5\textwidth}
	\subfloat[Heat map for topic models with 25 and 50 topics]{
		\includegraphics[width=7cm]{gfx/english-editorial-InternConsistency/js2550.png}}
	\end{minipage}
	\begin{minipage}[t]{0.5\textwidth}
	\subfloat[Heat map for topic models with 50 and 75 topics]{
	\includegraphics[width=7cm]{gfx/english-editorial-InternConsistency/js5075.png}}
	\end{minipage}
	\begin{minipage}[t]{0.5\textwidth}
	\subfloat[Heat map for topic models with 25 and 75 topics]{
	\includegraphics[width=7cm]{gfx/english-editorial-InternConsistency/js2575.png}}
	\end{minipage}
	\begin{minipage}[t]{0.5\textwidth}
	\subfloat[Heat map for topic models with 80 and 130 topics]{
	\includegraphics[width=7cm]{gfx/english-editorial-InternConsistency/jh80130.png}}
	\end{minipage}
	\begin{minipage}[t]{0.5\textwidth}
	\subfloat[Heat map for topic models with 80 and 180 topics]{
	\includegraphics[width=7cm]{gfx/english-editorial-InternConsistency/js80180.png}}
	\end{minipage}
	\begin{minipage}[t]{0.5\textwidth}
	\subfloat[Heat map for the topic models with 130 and 180 topics]{
	\includegraphics[width=7cm]{gfx/english-editorial-InternConsistency/js130180.png}}
	\end{minipage}
...
\begin{figure}
	\begin{minipage}[t]{0.5\textwidth}
		\subfloat[Heat map for topic models with 25 and 50 topics]{
			\includegraphics[width=7cm]{gfx/JensenSH/js5025.png}}
	\end{minipage}
	\begin{minipage}[t]{0.5\textwidth}
		\subfloat[Heat map for topic models with 25 and 75 topics]{
			\includegraphics[width=7cm]{gfx/JensenSH/js2575.png}}
	\end{minipage}
	\begin{minipage}[t]{0.5\textwidth}
		\subfloat[Heat map for topic models with 50 and 75 topics]{
			\includegraphics[width=7cm]{gfx/JensenSH/js5075.png}}
	\end{minipage}
	\begin{minipage}[t]{0.5\textwidth}
